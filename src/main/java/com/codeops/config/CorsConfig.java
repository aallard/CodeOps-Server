...
/**
 * Configures Cross-Origin Resource Sharing (CORS) policy for the CodeOps API.
 *
...
public class CorsConfig {
     ...
     * {@code Authorization}, {@code Content-Type}, and {@code X-Requested-With} request headers.
