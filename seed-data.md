...
**Before you start:** read the connection details from `CodeOps-Core/src/main/resources/application.yml` to get the JDBC URL, username, and password. Use `psql` to connect and execute.
